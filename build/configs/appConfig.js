...
class AppConfig {
    constructor() {
        ...
        this.postService = new PostService(this.postgresRepoFactory, this.fileService);
        this.userService = UserService.getInstance(this.postgresRepoFactory, this.fileService);
        this.tokenService = new TokenService();
        this.authService = new AuthService(this.userService, this.tokenService);
        // Controllers
        this.authController = new AuthController(this.authService, this.tokenService);
        this.petController = new PetController(this.tokenService);
        this.userController = UserController.getInstance(this.userService, this.tokenService);
        this.postController = new PostContorller(this.postService, this.tokenService);
    }
}
